...
const CertificateSlider = ({ certificates }) => {
    ...
    return (
        <section name='Educacao' className='relative w-full h-unset md:h-screen text-white'>
            ...
            <ScrollLink to="Contato" smooth duration={500} className='absolute bottom-0 -left-full md:left-1/2 md:-translate-x-1/2 cursor-pointer hover:text-primary-color'>
