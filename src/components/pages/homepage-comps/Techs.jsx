    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
        <div>
          ...
          <p className="py-6">Essas sao as tecnologias que eu trabalho</p>
        </div>
      ...
      <ScrollLink
        ...
        smooth
        duration={500}
        className="absolute bottom-0 -left-full md:left-1/2 md:-translate-x-1/2 cursor-pointer hover:text-primary-color"
      >
